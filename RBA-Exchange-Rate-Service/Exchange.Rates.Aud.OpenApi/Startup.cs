...
using Exchange.Rates.Aud.OpenApi.Extensions;
using Exchange.Rates.Aud.OpenApi.Filters;
using Exchange.Rates.Aud.OpenApi.Options;
using MassTransit;
...
namespace Exchange.Rates.Aud.OpenApi;

public class Startup(IConfiguration configuration)
{
    private const string SERVICE_NAME = "Exchange.Rates.Aud.OpenApi";
    ...
    public virtual void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            x.AddRequestClient<ISubmitAudExchangeRateSymbols>();
