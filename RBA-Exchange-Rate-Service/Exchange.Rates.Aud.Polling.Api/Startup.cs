...
using Exchange.Rates.Aud.Polling.Api.Policies;
...
namespace Exchange.Rates.Aud.Polling.Api;

public class Startup(IConfiguration configuration)
{
    private const string SERVICE_NAME = "Exchange.Rates.Aud.Polling.Api";
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddHttpClient<IAudExchangeRatesApi, AudExchangeRatesApi>()
    ...
    {
        services.AddScoped<IAudExchangeRatesApi, AudExchangeRatesApi>();
    }
}